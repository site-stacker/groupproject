...
import {updateHeaderBackgroundColor} from "./../../../redux/reducer"
...
class ColorPicker extends Component {
  ...
  handleSelection = (num) => {
    this.props.updateHeaderBackgroundColor(num)
...
export default connect(mapStateToProp, {updateHeaderBackgroundColor})(ColorPicker)
